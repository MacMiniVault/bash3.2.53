...
# Uninstalls pached bash binaries from https://github.com/MacMiniVault/bash3.2.53/releases
...
echo "It doesn't look like you are running OS X 10.8 or newer, can't execute"
fi
